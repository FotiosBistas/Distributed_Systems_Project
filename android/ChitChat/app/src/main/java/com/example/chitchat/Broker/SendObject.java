...
public class SendObject implements Runnable{
    private final ObjectOutputStream localoutputStream;
    private final ObjectInputStream localinputStream;
    ...
    private void shutdownConnection(){
        try {
            ...
            System.out.println(ConsoleColors.RED + "Error while shutting down connection" + ConsoleColors.RESET);
